        ...
        <div id="Edit-properties">
            ...
            <div id="Edit-properties-properties">
                <div className="Edit-property">
                    <img src={process.env.PUBLIC_URL + "/imgs/contrast.svg"} alt="contrast" />
                ...
                <div className="Edit-property">
                    <img src={process.env.PUBLIC_URL + "/imgs/gamma.svg"} alt="gamma" />
                    <div className="Edit-arrows">
                        <div className="Edit-arrows-buttons">
                ...
                <div className="Edit-property">
                    <img src={process.env.PUBLIC_URL + "/imgs/palette.svg"} alt="palette" />
                    <div className="Edit-arrows">
                        <div className="Edit-arrows-buttons">
