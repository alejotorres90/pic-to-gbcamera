...
function Body() {
  return (
    <div className="Body-container">
      <Explanation />
      <Share />
      <p className="Body-credits">The project was made using <a href="https://maple.pet/">maple mavica syrup</a>'s wonderful <a href="https://maple.pet/webgbcam/">webgbcam</a> as a base. Check it out!</p>
