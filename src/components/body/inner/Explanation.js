        ...
        <div className="Explanation-container">
            ...
            <div className="Explanation-looks">
                ...
                <div className="Explanation-looks-inner">
                    <img src={process.env.PUBLIC_URL + "/imgs/example.png"} alt="original pic" />
                    <img id="Explanation-looks-arrow" src={process.env.PUBLIC_URL + "/imgs/arrow.svg"} alt="" />
                    <img src={process.env.PUBLIC_URL + "/imgs/example2.png"} alt="filtered pic" />
                </div>
            </div>
        </div>
    );
